    ...
    return (
        ...
        <footer class="text-gray-600 body-font">
             ...
             <div class="content flex py-2">
                 <img class="w-5 h-5" src={mail} alt="">
                 </img>
              <div class="item-body text-sm text-gray-500 px-2">
               ...
               <div class="content flex py-2">
                 <img class="w-5 h-5" src={telephone} alt="">
                 </img>
                 <div class="item-body text-sm text-gray-500 px-2">
                   023-691-456-978
                 </div>
                                    ...
                                    <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">
                                      ...
                                      <nav class="list-none mb-10">
                                       <li>
                                         ...
                                         <a href="" class="mt-2 text-sm text-gray-500 hover:text-green-500">
                                            Round Trip
                                         </a>
                                       </li>
                                         <li>
                                              ...
                                              <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                                                <p class="text-gray-500 text-sm text-center sm:text-left">
                                                   ...
                                                   Copyright @Vaccation2021
                                                     <a href="https://www.tailwind-elements.com/"
