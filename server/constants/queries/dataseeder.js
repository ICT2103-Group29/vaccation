...
const INSERT_COUNTRY =
  "INSERT IGNORE INTO country (country_name, iso) VALUES ?";
const INSERT_COUNTRYVACC =
  "INSERT IGNORE INTO country_vaccinated (iso, total_fully_vacc, total_vacc, vacc_percent) VALUES ?";
const INSERT_COUNTRYRES =
  "INSERT IGNORE INTO country_restriction (iso, procedures, restrictions) VALUES ?";
